...
let Icons = [
  { name: <PiTwitterLogoFill />, href: "https://twitter.com/omd_tech" },
  { name: <PiInstagramLogoFill />, href: "https://instagram.com/omd_tech " },
  { name: <PiGithubLogoFill />, href: "https://github.com/OMD-TECH" },
  { name: <PiFacebookLogoFill />, href: "https://web.facebook.com/people/OMD_Tech/" },
];
...
const people = [
  ...
  },
  {
    ...
    designation: "@omd_tech",
    image: "/img/alarm.png",
    href: "https://twitter.com/omd_tech",
  },
  {
    id: 3,
    name: "GITHUB",
    designation: "@omd_tech",
    image: "/img/party.png",
    href: "https://github.com/OMD-TECH",
  },
];
...
function Headpage() {
  ...
  return (
    <>
      <div className="flex justify-between items-center md:max-w-5xl max-w-lg mx-auto lg:mt-16 mt-11 md:px-8 px-9">
