...
const people = [
  {
    ...
    image: "/img/email.png",
    href: "https://instagram.com/omd_tech ",
  },
];
...
function PageHook() {
  ...
  return (
    <div className="h-full w-full p-3 flex items-center justify-center relative z-50">
      ...
      <div className="absolute left-0 opacity-30 -z-10">
        <Image
          src={"/img/fxemoji_bookmarktab.png"}
          height={200}
          width={200}
        />
      </div>
        ...
        <div className="space-y-4 ">
          <div className="space-y-2 text-center">
            <div className="flex justify-center items-center">
              ...
              <Image
                ...
                height={128}
                alt="shake head"
                src={"/img/omd logo.jpeg"}
                className="w-16 h-16 rounded-full"
              />
              <FaHandshake className="text-[25px] text-[orange] mx-3"/>
              <Image
                width={128}
                height={128}
                alt="shake head"
                src={"/img/NUESA logo.jpeg"}
              ...
              <div className="p-[1px] bg-transparent  relative">
                <div className="p-2 ">
                  ...
                  <span className="bg-clip-text text-transparent dark:bg-gradient-to-r bg-gradient-to-tr dark:from-white from-black to-neutral-600 dark:to-neutral-700">
                    Partnership Between OMD Tech & NUESA
                  </span>
                </div>
              </div>
            ...
            <h1 className="text-3xl font-bold  sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent dark:bg-gradient-to-r bg-gradient-to-tr dark:from-white from-black to-neutral-600 dark:to-neutral-800 capitalize md:max-w-2xl lg:max-w-3xl mx-auto mb-5 ">
              Join The Waitlist for Our E-library Today!
            </h1>
            <p className="max-w-[600px]  leading-7 text-center text-[16px] bg-clip-text text-transparent dark:bg-gradient-to-br bg-gradient-to-tr dark:from-white from-black to-neutral-600 dark:to-neutral-700 mx-auto ">
              Be Prepared to Discover an Array of Incredible Materials for different Courses, an
          ...
          <div className="p-3 rounded-lg border dark:border-white/10 border-neutral-400 dark:border-opacity-10 relative top-14 sm:top-14 lg:top-24 max-w-xl mx-auto flex flex-col lg:flex-row justify-between items-center text-sm">
            <p className=" text-zinc-500 dark:text-zinc-100">
              Get ready to redefine your learning experience.
            </p>
            <Link
      ...
      <div className="absolute right-0 opacity-20 -z-10 top-80 max-md:top-[500px]">
        <Image
          src={"/img/fxemoji_bluebook(1).png"}
          height={200}
          width={200}
        />
      </div>
          ...
          >
            ...
            <div className="relative z-10">
              <p className=" text-center text-lg mt-4  mb-6">
                We'll send a notification as soon as v1 is ready for you to
                experience
              </p>
              <div className="flex gap-2">
                <button
